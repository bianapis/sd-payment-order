 ...
 */
public class PaymentOrderUpdateBaseWithRoot   {
  private String paymentOrderRequestReference = null;

  private String paymentOrderUpdateReference = null;
  ...
  private String paymentOrderUpdateResult = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier       
   * @return paymentOrderUpdateReference
  **/

  public String getPaymentOrderUpdateReference() {
    return paymentOrderUpdateReference;
  }

  public void setPaymentOrderUpdateReference(String paymentOrderUpdateReference) {
    this.paymentOrderUpdateReference = paymentOrderUpdateReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text     
   * @return paymentOrderUpdateResult
  **/

  public String getPaymentOrderUpdateResult() {
    return paymentOrderUpdateResult;
  }

  public void setPaymentOrderUpdateResult(String paymentOrderUpdateResult) {
    this.paymentOrderUpdateResult = paymentOrderUpdateResult;
  }
