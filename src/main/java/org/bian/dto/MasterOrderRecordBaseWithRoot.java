 ...
 */
public class MasterOrderRecordBaseWithRoot   {
  ...
  private String paymentMechanismReference = null;

  private String paymentMechanismType = null;

  private String paymentMechanismProperties = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier     
   * @return paymentMechanismReference
  **/

  public String getPaymentMechanismReference() {
    return paymentMechanismReference;
  }

  public void setPaymentMechanismReference(String paymentMechanismReference) {
    this.paymentMechanismReference = paymentMechanismReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text     
   * @return paymentMechanismProperties
  **/

  public String getPaymentMechanismProperties() {
    return paymentMechanismProperties;
  }

  public void setPaymentMechanismProperties(String paymentMechanismProperties) {
    this.paymentMechanismProperties = paymentMechanismProperties;
  }
